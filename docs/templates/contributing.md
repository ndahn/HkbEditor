...
The best (that is, for me easiest) way to include a new template is by writing it, testing it and then sending it to me :yum:
...
Ideally you can also highlight any important details, like looped clips or non-standard transition effects, but I will check for these myself as I work on it. At the very least I need to know where to start looking and how it should work, so please do your research. Testing will always be up to you :innocent:
