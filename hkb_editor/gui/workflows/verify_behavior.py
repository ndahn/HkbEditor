...
def check_xml(behavior: HavokBehavior, logger: logging.Logger) -> None:
...
def check_statemachines(behavior: HavokBehavior, logger: logging.Logger) -> None:
...
def check_attributes(behavior: HavokBehavior, logger: logging.Logger) -> None:
...
def check_graph(behavior: HavokBehavior, logger: logging.Logger) -> None:
...
def check_nameidfiles(behavior: HavokBehavior, logger: logging.Logger) -> None:
    logger.info("-> checking nameid files...")
...
def verify_behavior(behavior: HavokBehavior) -> None:
    ...
    check_nameidfiles(behavior, logger)
